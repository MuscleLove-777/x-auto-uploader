...
TWEET_TEMPLATES = [
    # 煽りモード
    "この{category}の身体、気になるでしょ？笑💪\n続きはリンクで♡\n\n{hashtags}\n\n🔥 {patreon}",
    "見せてあげる✨ {category}のむき出しの筋肉美\n…の続きが気になったら♡\n\n{hashtags}\n\n{patreon}",
    "凛花の{category}、仕上がってるでしょ？🔥\nぜんぶ見たいならこっち♡\n\n{hashtags}\n\n{patreon}",
    # カジュアルモード
    "{category}バキバキで草ｗｗ💪\nこの身体やばくないですか( ´∀｀ )\n\n{hashtags}\n\n{patreon}",
    "カイの{category}がえぐいんだがｗｗ🔥\nもっと見たい人はこちら✨\n\n{hashtags}\n\n{patreon}",
    "ましろの無防備な{category}…じっとり汗かいてるの良くないですか( ´∀｀ )♡\n\n{hashtags}\n\n{patreon}",
    # トレンド意識
    "仕上がってる💪 {category} is insane🔥\nThis body is art✨\n\n{hashtags}\n\n{patreon}",
    "バキバキの{category}、好き放題に見て♡\nFull content here 💪\n\n{hashtags}\n\n{patreon}",
    # ストレート
    "この{category}の身体にぶちまけたくなるでしょ🔥\n紫苑が見せてあげる♡\n\n{hashtags}\n\n{patreon}",
    "鍛え上げた{category}、濡れるほどの筋肉美💪\nアヤネは別に見てほしいわけじゃないけど…♡\n\n{hashtags}\n\n{patreon}",
    "むき出しの{category}を絞り上げる✨\n詰め込んだ全てがここに🔥\n\n{hashtags}\n\n{patreon}",
    # ビジュアル重視
    "💪🔥 {category}\n\n{hashtags}\n\n✨ {patreon}",
    "{category} 🔥✨💪\n\n{hashtags}\n\n♡ {patreon}",
    "✨ {category} ✨\nMuscle is beautiful💪\n\n{hashtags}\n\n🔥 {patreon}",
